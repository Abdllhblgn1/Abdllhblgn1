...
$messagesor=$db->prepare("SELECT * FROM roomtrr where message_from='rm' ");
$messagesor->execute();
...
<br><br><br><br>
<center><h2> <em style="color:#ed563b;">Romania</em> Room <i class="fa fa-comment-o" aria-hidden="true"></i></h2></center><br>
 <?php 
...
<div style="width:78%; margin: 0 auto; max-width: 2000px; padding: 0 20px; ">
	<form action="islem.php" method="POST">
     ...
     <input type="hidden" name="message_from" value="rm">
