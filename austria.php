...
$kullanicisor=$db->prepare("SELECT * FROM kullanici where kullanici_gidilecek_ulke='Austria'");
                  ...
                  <article id='tabs-1'>
                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-6">
                            ...
                            <p><img src="assets/images/austriaflag.png" alt="Austria Flag" style="height:15%; width:40%; "></p>
                       </div>
                    </div>
                  </article>
                  <article id='tabs-2'>
                    ...
                    <p>Austria, officially the Republic of Austria (German: Republik Österreich, About this soundlisten (help·info)), is a landlocked East Alpine country in the southern part of Central Europe. It is composed of nine federated states (Bundesländer), one of which is Vienna, Austria's capital and its largest city. It is bordered by Germany to the northwest, the Czech Republic to the north, Slovakia to the northeast, Hungary to the east, Slovenia and Italy to the south, and Switzerland and Liechtenstein to the west. Austria occupies an area of 83,879 km2 (32,386 sq mi) and has a population of nearly 9 million people. While German is the country's official language,[11] many Austrians communicate informally in a variety of Bavarian dialects.[12]
...
(Wikipedia)</p>
               ...
               <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1375058.1664937786!2d12.224816015892637!3d47.69101325634152!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x476d079b259d2a7f%3A0x1012d47bdde4c1af!2sAvusturya!5e0!3m2!1str!2str!4v1611753280546!5m2!1str!2str" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                   </article>

                  <article id='tabs-3'>
                    <h4>Who going Austria with you ?</h4>
