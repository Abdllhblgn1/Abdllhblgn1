...
$kullanicisor=$db->prepare("SELECT * FROM kullanici where kullanici_gidilecek_ulke='Finland'");
                  ...
                  <article id='tabs-1'>
                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-6">
                            ...
                            <p><img src="assets/images/finlandflag.png" alt="" style="height:15%; width:40%; "></p>
                       </div>
                    </div>
                  </article>
                  <article id='tabs-2'>
                    ...
                    <p>Finland, officially the Republic of Finland (Finnish: Suomen tasavalta, Swedish: Republiken Finland (About this soundlisten to all)),[note 1] is a Nordic country located in Northern Europe. Finland shares land borders with Sweden to the west, Russia to the east, and Norway to the north and is defined by the Gulf of Bothnia to the west and the Gulf of Finland to the south that are part of the Baltic Sea. (Wikipedia)</p>
                   </article>
                   <article id='tabs-4'>
                    <h4>Map</h4>
                    
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7003702.371298313!2d17.094490072022616!3d64.62360469830864!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4681cadf4b32f6dd%3A0x146d63c75a810!2sFinlandiya!5e0!3m2!1str!2str!4v1611749043941!5m2!1str!2str" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                   </article>

                  <article id='tabs-3'>
                    <h4>Who going Finland with you ?</h4>
