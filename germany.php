...
$kullanicisor=$db->prepare("SELECT * FROM kullanici where kullanici_gidilecek_ulke='Germany'");
                  ...
                  <article id='tabs-1'>
                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-6">
                            ...
                            <p><img src="assets/images/germanyflag.png" alt=""></p>
                       </div>
                    </div>
                  </article>
                  <article id='tabs-2'>
                    ...
                    <p>Germany (German: Deutschland, German pronunciation: [ˈdɔʏtʃlant]), officially the Federal Republic of Germany (German: Bundesrepublik Deutschland, About this soundlisten),[e] is a country at the intersection of Central and Western Europe. It is situated between the Baltic and North seas to the north, and the Alps to the south. It borders Denmark to the north, Poland and the Czech Republic to the east, Austria and Switzerland to the south, and France, Luxembourg, Belgium, and the Netherlands to the west, and covers an area of 357,022 square kilometres (137,847 sq mi). (Wikipedia)</p>
                   </article>
                   <article id='tabs-4'>
                    <h4>Map</h4>
                    
                   <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5132291.478193746!2d5.969740399240577!3d51.08997616811747!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x479a721ec2b1be6b%3A0x75e85d6b8e91e55b!2sAlmanya!5e0!3m2!1str!2str!4v1611744994616!5m2!1str!2str" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                   </article>

                  <article id='tabs-3'>
                    <h4>Who going Germany with you ?</h4>
