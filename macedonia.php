...
$kullanicisor=$db->prepare("SELECT * FROM kullanici where kullanici_gidilecek_ulke='Malta'");
                  ...
                  <article id='tabs-1'>
                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-6">
                            ...
                            <p><img src="assets/images/macedoniaflag.png" alt="Macedonia Flag" style="height:15%; width:40%; "></p>
                       </div>
                    </div>
                  </article>
                  <article id='tabs-2'>
                    ...
                    <p>North Macedonia[c] (Macedonia until February 2019), officially the Republic of North Macedonia,[d] is a country in Southeast Europe. It gained independence in 1991 as one of the successor states of Yugoslavia. North Macedonia is a landlocked country bordering with Kosovo[e] to the northwest, Serbia to the north, Bulgaria to the east, Greece to the south, and Albania to the west.[9] It constitutes approximately the northern third of the larger geographical region of Macedonia. Skopje, the capital and largest city, is home to a quarter of the country's 2.06 million population. The majority of the residents are ethnic Macedonians, a South Slavic people. Albanians form a significant minority at around 25%, followed by Turks, Romani, Serbs, Bosniaks, and Aromanians (the latter including Megleno-Romanians in official statistics).
...
(Wikipedia)</p>
               ...
               <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1539028.0279956963!2d21.114987643576825!3d41.11456668567945!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1354159f70bc4809%3A0xe0f25ad6c81fc5b1!2sKuzey%20Makedonya!5e0!3m2!1str!2str!4v1611752663598!5m2!1str!2str" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
                   </article>

                  <article id='tabs-3'>
                    <h4>Who going Macedonia with you ?</h4>
